...
def HelloMsg():
    ...
    response.config(text=context, anchor="w")
...
title = tk.Label(window, text="Local Llama2  test", font=("Arial", 24), bg="yellow")
title.pack()

textbox_systemprompt = tk.Text(window,  height=5, width=100, font=("Arial", 12))
textbox_systemprompt.insert(tk.END, "你是一個英翻中的專家。請翻譯下列英文句子")
